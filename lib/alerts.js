/**
 * lib/alerts.js — Triple Alert System (v2 — Multi-Tenant Safe)
 * WhatsApp (wa.me links) + Email (via /api/alerts) + Push (PWA)
 *
 * KEY CHANGES v2:
 * - sanitizeIndianNumber() enforces 91XXXXXXXXXX format before every WA send
 * - hotelConfig is fetched fresh per hotelId — no cross-hotel data routing possible
 * - sendBookingAlerts() accepts optional explicit hotelConfig override for SSR contexts
 */
